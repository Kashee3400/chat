// When click Chat rules button then show chat rules dialog box
function showChatRules() {
    $('#chat-rules').modal('show');
}
...
$('#country').val(userCountry).attr('selected', 'selected')

$('#country').change(function () {
    var countryName = $('#country').find(':selected').val()
    $.ajax({
        url: '/change-country/',
        method: 'GET',
        data: {
